...
List<Category> categoriesData = [
  ...
  Category(
      image: 'assets/images/weldingMetalwork.png',
      name: 'Welding and Metalwork'),
  Category(
      image: 'assets/images/plasteringDrywall.png',
      name: 'Plastering and Drywall Repair'),
  Category(
      image: 'assets/images/homeCleaning.png', name: 'Home Cleaning Services'),
  Category(image: 'assets/images/locksmith.png', name: 'Locksmith Services'),
  Category(
      image: 'assets/images/ceilingFan.png',
      name: 'Ceiling and Exhaust Installation/Repair'),
